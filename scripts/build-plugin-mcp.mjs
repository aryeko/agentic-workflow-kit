...
await build({
  ...
  banner: {
    js: [
      '// Generated by scripts/build-plugin-mcp.mjs from packages/orchestrator/src/mcp/server.ts.',
      '// Do not edit by hand; run pnpm build:plugin-mcp.',
      'import { createRequire as __agenticWorkflowKitCreateRequire } from "node:module"; const require = __agenticWorkflowKitCreateRequire(import.meta.url);',
    ].join('\n'),
  },
  sourcemap: false,
});
