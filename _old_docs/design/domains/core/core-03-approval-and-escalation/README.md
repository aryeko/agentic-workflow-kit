...
### Required reading
Standard set + [core-02](../core-02-capability-and-safety/README.md),
[fnd-01](../../foundation/fnd-01-configuration-and-policy/README.md), and the Agent contract in
...
- [core-01 design](../core-01-run-lifecycle-and-state/README.md) and its contracts, writer, and
  lifecycle subfiles
- [core-02 design](../core-02-capability-and-safety/README.md) and its capability registry and gate
  record subfiles
- [fnd-01 design](../../foundation/fnd-01-configuration-and-policy/README.md) and its policy interfaces subfiles
- [prov-01 design](../../providers/prov-01-agent-execution/README.md) and its Agent contract/capability subfiles
