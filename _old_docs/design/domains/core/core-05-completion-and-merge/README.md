...
### Required reading
Standard set + [core-02](../core-02-capability-and-safety/README.md), the Forge contract in
[prov-02](../../providers/prov-02-forge-collaboration/README.md), the runner-owned verify in
[prov-04](../../providers/prov-04-execution-host/README.md), and local git evidence in
[fnd-03](../../foundation/fnd-03-workspace-and-repository/README.md).

### Deliverable
`README.md` defining: the evidence records; the completion + merge predicates; the merge-policy config
...
Read: `AGENTS.md`, the standard kit-vnext docs, the domain template, this README's Mandate, approved
...
and blocker PR rules are in [Evidence model and predicates](evidence-model-and-predicates.md).
