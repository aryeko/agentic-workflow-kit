...
### Required reading
Standard set + [core-01](../core-01-run-lifecycle-and-state/README.md),
[core-02](../core-02-capability-and-safety/README.md), and the lease primitive in
[fnd-02](../../foundation/fnd-02-storage-and-artifacts/README.md).
...
Read in order: `AGENTS.md`, `README.md`, `requirements.md`, `decisions.md`, `architecture.md`,
