---
title: "SDK provider ports and capability attestation - proposed draft"
status: proposed
target-corpus-path: "docs/design/20-sdk-and-packaging/provider-ports.md"
---

# SDK provider ports and capability attestation

This draft is proposed SDK-owned content for `docs/design/20-sdk-and-packaging/provider-ports.md`.
It hoists the production provider interfaces and the shared `CapabilityAttestation` payload into the
SDK section. Provider folders keep driver mappings, provider evidence, conformance suites, and
...
The SDK provider port file should import or cross-reference these already-owned types instead of
redefining them:
