...
Status: **APPROVED — 2026-06-21.** All recommendations accepted in one pass (incl. R-T9.4 — SDK
`*Provider` names canonical). Wave-3 is frozen; the apply phase may now proceed. These were the open
choices T9 surfaced, plus one ruling carried from Wave-1 T3 that became apply-blocking here.
...
**Decision:** ☑ Approve recommended **[APPROVED 2026-06-21]** ◻ Amend → ____ (skip)
...
**Decision:** ☑ Approve recommended **[APPROVED 2026-06-21]** ◻ Amend → ____ (keep deep-spec names canonical, alias SDK side)
