...
`charter.md`, approved core-01/core-02/fnd-02 designs and subfiles, approved provider seam designs
...
[Recovery model](design/recovery-model.md). Entry-point decisions:
