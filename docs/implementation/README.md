...
| [2](frontiers/frontier-2-provider-seams/charter.md) | Provider seams | `prov-03`, `prov-02`, `prov-04` | Define first provider contracts, mocks, and conformance expectations. |
| [3](frontiers/frontier-3-agent-and-core-gates/charter.md) | Agent and core gates | `prov-01`, `core-02`, `core-07` | Add the agent seam, capability gates, and analysis surface. |
