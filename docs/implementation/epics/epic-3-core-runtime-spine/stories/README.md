...
**↑ Up:** [Epic 3 - Core runtime spine](../README.md) · **← Prev:** [Epic 3 - story DAG](../story-dag.md) · **Next →:** [core-01-s1-event-contracts - host-neutral run-log contract surface implementation story](./core-01-s1-event-contracts.md)
