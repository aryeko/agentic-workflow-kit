# Implementer Prompt: core-07-s2-analyzer
...
Implement source story `core-07-s2-analyzer` for epic `epic-3-core-runtime-spine`. Deliver exactly the outcome in the ready source contract and nothing outside it:
...
The DAG dependents for this story are: `core-07-s3-analysis-records-and-reports`. Preserve the producer/consumer shape boundaries named above so later stories can consume committed dependency inputs without re-declaring or widening this story's scope.

## Required Reading

- `docs/implementation/epics/epic-3-core-runtime-spine/stories/core-07-s2-analyzer.md` — source story contract for `core-07-s2-analyzer`.
- `docs/implementation/epics/epic-3-core-runtime-spine/story-dag.md` — frozen DAG row, dependencies, owned pathset, wave, and suggested-tier floor for `core-07-s2-analyzer`.
...
Source story: `docs/implementation/epics/epic-3-core-runtime-spine/stories/core-07-s2-analyzer.md`. Source AC ids: `AC-1`, `AC-2`, `AC-3`, `AC-4`, `AC-5`, `AC-6`, `AC-7`, `AC-8`, `AC-9`, `AC-10`, `AC-11`, `AC-12`, `AC-13`, `AC-14`, `AC-15`, `AC-16`, `AC-17`, `AC-18`.
...
Source story: `docs/implementation/epics/epic-3-core-runtime-spine/stories/core-07-s2-analyzer.md`. Owned pathset from the frozen DAG and source contract:
...
Direct dependency story ids: `core-07-s1-telemetry-and-metrics`, `core-01-s1-event-contracts`.
...
**↑ Up:** [Epic 3 - Core runtime spine](../../../README.md) · **← Prev:** [Reviewer Prompt: core-07-s1-telemetry-and-metrics](../core-07-s1-telemetry-and-metrics/reviewer.md) · **Next →:** [Reviewer Prompt: core-07-s2-analyzer](./reviewer.md)
