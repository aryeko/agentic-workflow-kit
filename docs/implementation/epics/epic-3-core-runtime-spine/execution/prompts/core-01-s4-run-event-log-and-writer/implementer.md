# Implementer Prompt: core-01-s4-run-event-log-and-writer
...
Implement source story `core-01-s4-run-event-log-and-writer` for epic `epic-3-core-runtime-spine`. Deliver exactly the outcome in the ready source contract and nothing outside it:
...
- `docs/implementation/epics/epic-3-core-runtime-spine/stories/core-01-s4-run-event-log-and-writer.md` — source story contract for `core-01-s4-run-event-log-and-writer`.
- `docs/implementation/epics/epic-3-core-runtime-spine/story-dag.md` — frozen DAG row, dependencies, owned pathset, wave, and suggested-tier floor for `core-01-s4-run-event-log-and-writer`.
...
Source story: `docs/implementation/epics/epic-3-core-runtime-spine/stories/core-01-s4-run-event-log-and-writer.md`. Source AC ids: `AC-1`, `AC-2`, `AC-3`, `AC-4`, `AC-5`, `AC-6`, `AC-7`, `AC-8`, `AC-9`, `AC-10`.
...
Source story: `docs/implementation/epics/epic-3-core-runtime-spine/stories/core-01-s4-run-event-log-and-writer.md`. Owned pathset from the frozen DAG and source contract:

- `packages/sdk/src/core/run-lifecycle/log/**`
- `packages/sdk/tests/core/run-lifecycle/log/**`
...
Direct dependency story ids: `core-01-s1-event-contracts`, `core-01-s2-replay-and-corruption`, `core-01-s3-lifecycle-and-linkage`, `core-01-s5-projections`, `core-01-s6-cursor-wait`.
...
**↑ Up:** [Epic 3 - Core runtime spine](../../../README.md) · **← Prev:** [Reviewer Prompt: core-01-s3-lifecycle-and-linkage](../core-01-s3-lifecycle-and-linkage/reviewer.md) · **Next →:** [Reviewer Prompt: core-01-s4-run-event-log-and-writer](./reviewer.md)
