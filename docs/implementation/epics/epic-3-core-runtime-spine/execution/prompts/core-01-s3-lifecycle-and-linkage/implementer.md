# Implementer Prompt: core-01-s3-lifecycle-and-linkage
...
Implement source story `core-01-s3-lifecycle-and-linkage` for epic `epic-3-core-runtime-spine`. Deliver exactly the outcome in the ready source contract and nothing outside it:
...
The DAG dependents for this story are: `core-01-s4-run-event-log-and-writer`, `core-01-s5-projections`. Preserve the producer/consumer shape boundaries named above so later stories can consume committed dependency inputs without re-declaring or widening this story's scope.

## Required Reading

- `docs/implementation/epics/epic-3-core-runtime-spine/stories/core-01-s3-lifecycle-and-linkage.md` — source story contract for `core-01-s3-lifecycle-and-linkage`.
- `docs/implementation/epics/epic-3-core-runtime-spine/story-dag.md` — frozen DAG row, dependencies, owned pathset, wave, and suggested-tier floor for `core-01-s3-lifecycle-and-linkage`.
...
Source story: `docs/implementation/epics/epic-3-core-runtime-spine/stories/core-01-s3-lifecycle-and-linkage.md`. Source AC ids: `AC-1`, `AC-2`, `AC-3`, `AC-4`, `AC-5`, `AC-6`, `AC-7`, `AC-8`, `AC-9`, `AC-10`, `AC-11`, `AC-12`, `AC-13`, `AC-14`.
...
Source story: `docs/implementation/epics/epic-3-core-runtime-spine/stories/core-01-s3-lifecycle-and-linkage.md`. Owned pathset from the frozen DAG and source contract:
...
**↑ Up:** [Epic 3 - Core runtime spine](../../../README.md) · **← Prev:** [Reviewer Prompt: core-01-s2-replay-and-corruption](../core-01-s2-replay-and-corruption/reviewer.md) · **Next →:** [Reviewer Prompt: core-01-s3-lifecycle-and-linkage](./reviewer.md)
