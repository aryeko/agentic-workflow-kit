---
title: "core-05-s1-completion-contracts implementation story"
id: "core-05-s1-completion-contracts"
epic: 5
status: "story: ready"
design:
...
|---|---|---|---|---|
| AC-1..AC-3 | catalog membership and exhaustiveness | literals listed in normative design unions | owned catalog constants | decidable |
| AC-8..AC-9 | catalog membership and exhaustiveness | literals listed in changed-file and blocker behavior design | owned catalog constants | decidable |
...
| Runtime catalogs | every literal in AC-1..AC-3 plus changed-file/blocker catalogs | explicit catalog literals from design | closed |
...
The `packages/sdk/src/core/completion/contracts/**` public contract module, tests, fixtures, and SDK
export lines.
...
- Failure-token/catalog closure: this story owns the exact core-05 catalogs consumed by later stories,
  including changed-file classes and blocker-evidence eligibility.
- Verdict: ready.
...
**↑ Up:** [Epic 5 - stories](./README.md) · **← Prev:** [Epic 5 - stories](./README.md) · **Next →:** [core-05-s2-completion-evidence implementation story](./core-05-s2-completion-evidence.md)
