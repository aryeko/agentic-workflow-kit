...
Gate-1 handoff: 8 of 8 stories are `story: ready`; the DAG is `story-dag: frozen`. Next stage:
`plan-delivery`.
...
| `core-04-s2-liveness-fold` | `story: ready` | Pure liveness fold and advancing/non-refresh event classes. |
| `core-04-s3-timers-wait` | `story: ready` | Six supervision timers plus wait wrapper. |
| `core-04-s4-termination-facts` | `story: ready` | Supervisor facts, supervision-lost, termination handoff, and stop ordering. |
