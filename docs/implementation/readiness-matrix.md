...
| Frontier | Domain | design-approved | story contract | package implemented | conformance / integration | runtime attestation | notes |
|---|---|---:|---:|---:|---:|---:|---|
...
| 1 | `fnd-04` Credentials & Secrets | yes | no | no | no | no | Story contract pending. |
...
| 3 | `core-02` Capability & Safety | yes | no | no | no | no | Story contract pending. |
| 3 | `core-07` Observability & Analysis | yes | no | no | no | n/a | Story contract pending. |
| 4 | `core-03` Approval & Escalation | yes | no | no | no | no | Story contract pending. |
| 4 | `core-04` Supervision & Liveness | yes | no | no | no | no | Story contract pending. |
| 5 | `core-05` Completion, Verification & Merge | yes | no | no | no | no | Story contract pending. |
| 5 | `core-06` Recovery & Reconciliation | yes | no | no | no | no | Story contract pending. |
...
- runtime attestation: capability attestation evidence exists for the named driver or capability.
