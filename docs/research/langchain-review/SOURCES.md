# LangChain ecosystem review sources
...
README verification: the live README project list matched the request's known list: LangChain,
LangChain.js, LangGraph, LangGraph.js, Deep Agents, Deep Agents.js, LangSmith, Deep Agents Code,
Open SWE, MCP Adapters, and Agent Protocol.

## Shared kit-vnext local sources

- `AGENTS.md`
- `design-closure/prompts/run-apply.md`
...
- Domain README files under `docs/design/30-domain-reference/`
...
- [LangChain.js repository README](https://github.com/langchain-ai/langchainjs)
...
- [langchain-ai/deepagents repository](https://github.com/langchain-ai/deepagents)
...
- [langchain-ai/deepagentsjs repository](https://github.com/langchain-ai/deepagentsjs)
...
- [Agent Protocol repository README](https://github.com/langchain-ai/agent-protocol)
