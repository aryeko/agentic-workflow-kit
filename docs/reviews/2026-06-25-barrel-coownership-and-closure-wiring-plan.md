...
**↑ Up:** [agentic-workflow-kit — documentation home](../README.md) · **← Prev:** [Turbo Check-Gate Caching (design)](../engineering/turbo-check-caching-design.md) · **Next →:** [Closure-Defect Remediation — Durable Execution Plan](./2026-06-25-closure-remediation-plan.md)
