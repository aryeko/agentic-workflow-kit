...
**↑ Up:** [documentation home](../README.md) · **← Prev:** [Turbo Check-Gate Caching (design)](../engineering/turbo-check-caching-design.md) · **Next →:** [Producer↔Consumer Closure Audit — kit-vnext design corpus](./2026-06-25-producer-consumer-closure-audit.md)
