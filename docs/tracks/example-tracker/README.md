...
in [example-prd](../../../examples/example-prd/README.md). The PRD owns what/why; this tracker owns
sequencing and parallelism. Each story (`LK`n) has a lightweight brief under [`stories/`](./stories/);
`implement-next` creates the detailed technical story spec and implementation plan before code.*

## Context

1. **Why this track exists.** It decomposes [example-prd](../../../examples/example-prd/README.md)
   (Linkly) into shippable stories. The ship-blockers are `L-1` (submit a long URL, get a short code)
...
- [../../../examples/example-prd/README.md](../../../examples/example-prd/README.md) — the PRD this track decomposes
