...
| AWK06 | Runtime event and artifact model | AWK02 | W3 | implementing | [brief](./stories/AWK06.md) + [spec](../../superpowers/specs/2026-06-14-awk06-runtime-event-and-artifact-model-design.md) | — | codex | — |
