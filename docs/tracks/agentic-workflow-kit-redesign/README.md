...
| AWK134 | AWK13.4 Conservative defaults and API fidelity | AWK131 | W7.2 | implementing | [brief](./stories/AWK134.md) + [spec](../../superpowers/specs/2026-06-14-awk134-conservative-defaults-and-api-fidelity-design.md) | — | codex-2026-06-14T09-55-09Z | — |
