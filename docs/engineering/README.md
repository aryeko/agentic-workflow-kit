...
**↑ Up:** [agentic-workflow-kit — documentation home](../README.md) · **← Prev:** [implementation lessons ledger](../implementation-authoring/lessons-ledger.md) · **Next →:** [Check Gate](./check-gate.md)
