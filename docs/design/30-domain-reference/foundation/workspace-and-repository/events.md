# Workspace & Repository event payloads

This file is the fnd-03-owned payload catalog for the Workspace & Repository events listed in the
domain README. Core-01 owns the run event envelope and append protocol; fnd-03 owns these payload
schemas.
...
**↑ Up:** [Workspace & Repository](./README.md) · **← Prev:** [Workspace & Repository](./README.md) · **Next →:** [Credentials & Secrets](../credentials-and-secrets/README.md)
