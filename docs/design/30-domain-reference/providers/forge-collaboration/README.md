...
### Required reading
Standard set + AD-12 in [decisions.md](../../../40-decisions/accepted-decisions.md) and the provider evidence/conformance rules
in [conventions.md](../../../00-orientation/conventions.md). GitHub API facts go in this domain's dated `evidence/`
...
[fnd-04 README and Mandate](../../foundation/credentials-and-secrets/README.md), and fnd-04
[contracts-and-events.md](../../foundation/credentials-and-secrets/contracts-and-events.md).
