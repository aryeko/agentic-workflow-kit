...
### Required reading
Standard set + [prov-04](../execution-host/README.md) and the provider evidence/conformance
rules in [conventions.md](../../../00-orientation/conventions.md). Codex protocol facts go in this domain's dated
`evidence/` appendix (generate the app-server schema for the pinned version).

### Deliverable
`README.md` defining: the Agent contract + attested capabilities (validated against Codex **and** the
...
`README.md#mandate`, `prov-04` README Mandate and design including `contracts-and-conformance.md`, and
`fnd-04` README Mandate and design. No legacy docs, memory, external web/API sources, or repository files
...
- [contracts-and-conformance.md](contracts-and-conformance.md) - typed Agent contract.
- [capabilities-and-conformance.md](capabilities-and-conformance.md) - capability set,
  event invariants, and conformance suite.
- [codex-driver.md](codex-driver.md) - Phase 0/Phase 1 Codex mapping, approval enum mapping,
  Guardian treatment, process-parentage rules, and evidence gates.
- [mock-driver.md](mock-driver.md) - programmable adversarial driver and incident replay
  fixtures.
