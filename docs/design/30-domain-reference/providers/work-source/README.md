...
### Required reading
Standard set + the two-authorities note in [architecture.md](../../../10-architecture/architecture.md) §5.

### Deliverable
`README.md` defining: the Work Source contract + capability set + task model (validated against
