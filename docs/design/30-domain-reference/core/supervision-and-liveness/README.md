...
### Required reading
Standard set + [core-01](../run-lifecycle-and-state/README.md) and the Agent contract in
...
[README.md#mandate](README.md#mandate), approved [core-01 design](../run-lifecycle-and-state/README.md)
and subfiles, approved [prov-01 Agent Execution design](../../providers/agent-execution/README.md) and
contract subfiles, and approved [prov-04 Execution Host design](../../providers/execution-host/README.md)
