...
### Required reading
Standard set + [core-02](../capability-and-safety/README.md), the Forge contract in
[prov-02](../../providers/forge-collaboration/README.md), the runner-owned verify in
[prov-04](../../providers/execution-host/README.md), and local git evidence in
[fnd-03](../../foundation/workspace-and-repository/README.md).
...
Read: the standard design docs, the domain template, this README's Mandate, approved
