...
### Required reading
Standard set + [core-01](../core-01-run-lifecycle-and-state/README.md) and the capability
...
[README.md#mandate](README.md#mandate). Approved dependency read: [core-01 design](../core-01-run-lifecycle-and-state/README.md),
[contracts](../core-01-run-lifecycle-and-state/contracts.md),
[event log protocol](../core-01-run-lifecycle-and-state/event-log-writer-and-corruption.md), and
[projection/lifecycle rules](../core-01-run-lifecycle-and-state/projections-lifecycle-and-tests.md).
Provider contract inputs read: [prov-01](../../providers/prov-01-agent-execution/README.md),
[prov-01 contracts](../../providers/prov-01-agent-execution/contracts-and-conformance.md),
[prov-01 capabilities](../../providers/prov-01-agent-execution/capabilities-and-conformance.md),
[prov-02](../../providers/prov-02-forge-collaboration/README.md), [prov-03](../../providers/prov-03-work-source/README.md),
[prov-04](../../providers/prov-04-execution-host/README.md), and
[prov-04 contracts](../../providers/prov-04-execution-host/contracts-and-conformance.md).
