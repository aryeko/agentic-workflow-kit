...
`decisions.md`, `_templates/domain-design-template.md`, this charter, the fnd-04 charter, fnd-04
`design.md`, and fnd-04 `design/contracts-and-events.md`. GitHub evidence is in
`evidence/2026-06-18/`.
