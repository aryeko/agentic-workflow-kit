...
`decisions.md` (AD-2, AD-13), this domain's `charter.md`, the `fnd-03` charter and design, and the
`fnd-04` charter, design, and `design/contracts-and-events.md`.
...
Typed details live in [contracts-and-conformance.md](design/contracts-and-conformance.md) to keep
...
- [x] Files are focused; contract and conformance detail is split into `design/contracts-and-conformance.md`.
