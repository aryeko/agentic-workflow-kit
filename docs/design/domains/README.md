...
| [core-06](core-06-recovery-and-reconciliation/charter.md) | Recovery, Reconciliation & Coordination | Core | Evidence-classified recovery, action-safety, repo-level leases | core-01/02; all seams |
| [core-07](core-07-observability-and-analysis/charter.md) | Observability & Analysis | Core | Structured telemetry + auto-firing analyzer + metric honesty | core-01; fnd-02 |
