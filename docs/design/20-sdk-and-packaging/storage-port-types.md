...
This is the canonical SDK-facing typed contract for fnd-02 Storage & Artifacts. Every type below
cites the fnd-02 README section its prose semantics derive from. Where the fnd-02 README section 5
already declares a type verbatim, this file reproduces it unchanged and adds the prose citation;
where a type is prose-only in the README (sections 4/6/8), this file types it here and flags it
**[newly typed]**.
...
// record-internal and NOT part of the consumer-facing snapshot.
type LeaseSnapshot = {
  name: string;
  epoch: number;
  holder: string;
...
**↑ Up:** [SDK & packaging overview](./README.md) · **← Prev:** [SDK provider ports and capability attestation](./provider-ports.md) · **Next →:** [CLI and MCP wrappers](./cli-and-mcp-wrappers.md)
