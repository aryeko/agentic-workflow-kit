...
introduce no forbidden dependency. (See [architecture.md](../10-architecture/architecture.md) §2.)
...
- Reuse the component names from [architecture.md](../10-architecture/architecture.md) (Control plane, Agent contract,
