...
| 3 | [decisions.md](../40-decisions/accepted-decisions.md) | The architectural decisions and their rationale. |
| 4 | [architecture.md](../10-architecture/architecture.md) | Layers, the Dependency Rule, the capability model, diagrams, the domain map. |
...
| 7 | [domains/](../30-domain-reference/domain-catalog.md) | The 16 domain entries — each starts with its Mandate and then its design. |
...
A senior engineer picks up one domain. They read this README, [architecture.md](../10-architecture/architecture.md),
[domains/README.md](../30-domain-reference/domain-catalog.md), [conventions.md](conventions.md),
