...
export function buildGenericPrompt(
  ...
  return [
    ...
    '3. Before editing, run a child preflight: verify cwd, git top-level, current branch, expected worktree path, and configured base branch against the Git policy above.',
